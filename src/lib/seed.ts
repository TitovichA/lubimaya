  ...
  return {
    ...
    periodicHabits: [
      ...
      },
      {
        ...
        rule: { type: 'nthWeekday', n: 1, weekday: 0 },
        completions: {},
      },
      {
        id: 'ph-h3',
        areaId: 'home',
        title: 'Пересадить растения',
        rule: { type: 'everyNMonths', n: 3, day: 1, anchorMonth: 1 },
        completions: {},
      },
      {
        id: 'ph-h4',
        areaId: 'home',
        title: 'Заменить фильтры',
        rule: { type: 'yearly', month: 10, day: 1 },
        completions: {},
      },
      {
        id: 'ph-b1',
        areaId: 'body',
        title: 'Сдать анализы',
        rule: { type: 'everyNMonths', n: 6, day: 1 },
        completions: {},
      },
      {
        id: 'ph-b2',
        areaId: 'body',
        title: 'Стоматолог',
        rule: { type: 'everyNMonths', n: 6, day: 10 },
        completions: {},
      },
      {
        id: 'ph-b3',
        areaId: 'body',
        title: 'Маникюр',
        rule: { type: 'everyNDays', n: 21, anchorDate: today },
        completions: {},
      },
    ],
    businessEvents: [
    ...
    teamEvents: [
      {
        ...
        endDate: today,
        note: 'Отпуск',
        coverHint: 'Сегодня вы заменяете Юлию',
      },
    ],
    lifeBalance: {
      здоровье: 72,
