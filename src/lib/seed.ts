...
export function createSeedData(): AppData {
  ...
  return {
    ...
    goals: [
      {
        id: 'g-home',
        title: 'Уютный и организованный дом',
        description: 'Порядок, текстиль и пространство для отдыха',
        startDate: today,
        targetValue: 100,
        currentValue: 20,
        unit: '%',
      ...
      },
      {
        ...
        description: 'Системы, которые работают без вас',
        startDate: today,
        targetValue: 100,
        currentValue: 15,
        unit: '%',
      ...
      },
      {
        ...
        description: 'Тёплые вечера вместе',
        startDate: today,
        targetValue: 40,
        currentValue: 3,
        unit: 'вечеров',
